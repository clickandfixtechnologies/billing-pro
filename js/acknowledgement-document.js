...
CF.ackDocument = (() => {
  ...
  const html = record => {
    ...
    const signature = a.signatureData ? `<img class="ack-slip-signature-image" alt="Digital signature" src="${a.signatureData}">` : `<div>${a.signatureMethod === "physical" ? "Physical signature / stamp" : "—"}</div>`;
