...
CF.ackDocument = (() => {
  ...
  const normalize = record => {
    const signatureMethod = pick(record, "signature_method", "signatureMethod") || "digital";
    return ({
    ...
    verificationMethod: pick(record, "verification_method", "verificationMethod") || (signatureMethod === "physical" ? "Physical signed copy" : "Email OTP"),
